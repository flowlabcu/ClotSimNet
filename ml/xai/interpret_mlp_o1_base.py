...
def short_label(name: str) -> str:
    ...
    if name.startswith("glcm_"):
        ...
        try:
            ...
            return f"{feat} (d={parts[d_i]}, a={parts[a_i]})"
        except ValueError:
            return feat
    # 3) Laws textures  
...
plt.title('Top {} Input Feature Importances Across Multiple Algorithms, First-order Base MLP'.format(top_n), fontweight=weight, fontsize=font_size)
...
plt.tight_layout()
# plt.show()
plt.savefig('mlp_o1_base_attribs.svg')