...
SAFETENSORS_MODEL_PATH = '/home/josh/ClotSimNet-Models/base/mlp_dend/mlp_dend_base.safetensors'
...
plt.title('Top {} Input Feature Importances Across Multiple Algorithms, Dendrogram Base MLP'.format(top_n), fontweight=weight, fontsize=font_size)
...
plt.tight_layout()
# plt.show()
plt.savefig('mlp_dend_base_attribs.svg')