...
def interpret_base_low(
    ...
    if model_name in ('ENetB0','ENetB3','ENetB7'):
        model = getattr(EfficientNets, model_name)()
    elif model_name in ('ResNet18','ResNet50','ResNet152'):
        model = getattr(ResNets, model_name)()
    else:
    ...
    # Preprocess image
    image = Image.open(low_pack_path)
    ...
    plt.title(f"Grad-CAM Heatmap: Base {formatted_name}", fontweight='bold')
    plt.axis('off')
    ...
    out_name = f'grad_cam_plots/small_pack_{model_name.lower()}_base.pdf'
...
def interpret_base_high(
    ...
    # Preprocess image
    image = Image.open(high_pack_path)
    transform_pipeline = v2.Compose([
        v2.Grayscale(num_output_channels=1),
        v2.ToImage(),
        v2.ToDtype(torch.float32, scale=True),
    ...
    out_name = f'grad_cam_plots/large_pack_{model_name.lower()}_base.pdf'
    plt.savefig(out_name, format='pdf', bbox_inches='tight')
    print(f"Saved Grad-CAM heatmap to {out_name}")
...
if __name__ == '__main__':
    ...
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/enet_b0/enet_b0_base.safetensors',
        model_name='ENetB0',
        low_pack_path=low_pack_frac_path,
        formatted_name='EfficientNet-B0'
    )
    
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/enet_b3/enet_b3_base.safetensors',
        model_name='ENetB3',
        low_pack_path=low_pack_frac_path,
        formatted_name='EfficientNet-B3'
    )
    
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/enet_b7/enet_b7_base.safetensors',
        model_name='ENetB7',
        low_pack_path=low_pack_frac_path,
    ...
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/resnet_18/resnet_18_base.safetensors',
        model_name='ResNet18',
        low_pack_path=low_pack_frac_path,
        formatted_name='ResNet-18'
    )
    
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/resnet_50/resnet_50_base.safetensors',
        model_name='ResNet50',
        low_pack_path=low_pack_frac_path,
        formatted_name='ResNet-50'
    )
    
    interpret_base_low(
        model_path='/home/josh/ClotSimNet-Models/base/resnet_152/resnet_152_base.safetensors',
        model_name='ResNet152',
        low_pack_path=low_pack_frac_path,
        formatted_name='ResNet-152'
    )
