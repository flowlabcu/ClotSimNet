...
plt.title('Top {} Input Feature Importances Across Multiple Algorithms, First-order Tuned MLP'.format(top_n), fontweight=weight, fontsize=font_size)
...
plt.tight_layout()
# plt.show()
plt.savefig('mlp_o1_tuned_attribs.svg')