...
"""
train_convnext_large_base.py

Trains the base ConvNeXt-Large model. 
...
Usage:
    python3 train_convnext_large_base.py
"""
...
if __name__ == '__main__':
    ...
    model_type = 'Convnext_Large_base'
    dataset_size = '5k'
    ...
    RUN_NAME = 'ConvNext_Large_Base'
    
    # Model export settings/names
    model_name = 'convnext_large_base'
