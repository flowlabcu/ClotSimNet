...
- Hyperparameters JSON: `ClotSimNet-Models/hyperparameters/best_params_mlp_o1.json`
- Pretrained model: `ClotSimNet-Models/tuned/mlp_o1/mlp_o1_tuned.safetensors`
...
def main():
    ...
    BASE_RUN_NAME = 'mlp_o1_3d_pretrain_100'         # base name for WandB runs
    num_workers = 16
    max_epochs = 10
    
    hyperparameter_path = '/home/josh/ClotSimNet-Models/hyperparameters/best_params_mlp_o1.json'
    ...
    pretrained_model_dir = '/home/josh/ClotSimNet-Models/tuned/mlp_o1/'
    pretrained_model_name = 'mlp_o1_tuned'  # original model name (without extension)
