...
"""
train_mlp_full_3d_pretrain.py

This script fine-tunes a pretrained MLP model for predicting permeability from 3D clot data
using all available image features. It performs k-fold cross-validation with selective layer
...
- Hyperparameters JSON: `ClotSimNet-Models/hyperparameters/best_params_mlp.json`
- Pretrained model: `ClotSimNet-Models/tuned/mlp_full/mlp_full_tuned.safetensors`
...
def main():
    ...
    BASE_RUN_NAME = 'mlp_full_3d_pretrain_100'         # base name for WandB runs
    num_workers = 16
    max_epochs = 10
    
    hyperparameter_path = '/home/josh/ClotSimNet-Models/hyperparameters/best_params_mlp.json'
    ...
    pretrained_model_dir = '/home/josh/ClotSimNet-Models/tuned/mlp_full/'
    pretrained_model_name = 'mlp_full_tuned'  # original model name (without extension)
    ...
    test_module = load_data.MLPClotDataset(
        csv_path=test_path,
        num_workers=num_workers
    )
    test_module.setup()
