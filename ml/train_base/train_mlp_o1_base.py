...
"""
train_mlp_o1_base.py

Trains the base first-order MLP model. 
...
if __name__ == '__main__':
    ...
    model_type = 'MLP_o1_base'
    dataset_size = '5k'
    
    PROJECT_NAME = 'ClotSimNet'
    RUN_NAME = 'MLP_o1_Base'

    # Model export settings/names
    model_name = 'mlp_o1_base'
    # model_dir = '/projects/jogr4852/clotsimnet/ml/models/mlp_o1'
    model_dir = '/home/josh/clotsimnet/ml/models/mlp_o1'
