...
"""
train_enet_b3_base.py

Trains the base EfficientNet-B3 model. 
...
if __name__ == '__main__':
    ...
    RUN_NAME = 'ENetB3_Base_Scale'
    
    # Model export settings/names
    model_name = 'enet_b3_base_scale'
