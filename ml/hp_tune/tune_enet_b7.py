...
This script tunes an EfficientNet-B7 model for predicting permeability from grayscale CFD images
...
- Uses EfficientNet-B7 with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_enet_b7.json`.
...
# CNN EfficientNet b7 architecture
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_enet_b7_2.json'
