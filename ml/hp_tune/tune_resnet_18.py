...
- Uses ResNet-18 with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_resnet_18.json`.
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_resnet_18.json'
