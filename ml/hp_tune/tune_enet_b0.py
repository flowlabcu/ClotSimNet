...
This script tunes a EfficientNet-B0 model for predicting permeability from grayscale CFD images
...
- Uses EfficientNet-B0 with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_enet_b0.json`.
...
class ENetB0(L.LightningModule):
    def __init__(
        ...
        self.use_weights = True # Force use pre-trained weights
        self.batch_size = config['batch_size']
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_enet_b0.json'
