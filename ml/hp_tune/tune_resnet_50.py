...
This script tunes a ResNet-50 model for predicting permeability from grayscale CFD images
...
- Uses ResNet-50 with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_resnet_50.json`.
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_resnet_50_2.json'
