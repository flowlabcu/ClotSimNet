...
This script tunes a ConvNeXt-Tiny model for predicting permeability from grayscale CFD images
...
- Uses ConvNeXt-Tiny with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_convnext_tiny.json`.
...
PROJECT_NAME = 'tune_convnext_tiny'
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_convnext_tiny.json'
