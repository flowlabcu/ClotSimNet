...
This script tunes an EfficientNet-B3 model for predicting permeability from grayscale CFD images
...
- Uses EfficientNet-B3 with a custom grayscale input stem and single regression output.
...
- Automatically saves best config and loss to `hyper_params/best_params_enet_b3.json`.
...
# CNN EfficientNet b3 architecture
...
if __name__ == '__main__':
    ...
    file_name = 'best_params_enet_b3.json'
