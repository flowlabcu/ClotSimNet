...
Trains the EfficientNet-B0 architecture using tuned hyperparameters.
...
- hyperparams_path (str): Path to hyperparameter JSON file. Automatically looks for it in path clotsimnet/ml/hp_tune/hyperparams/best_params_enet_b0.json, but can be changed as needed.

Usage:
    python3 train_enet_b0.py
...
if __name__ == '__main__':
    ...
    RUN_NAME = 'ENetB0_Tuned'
    
    # Model export settings/names
    model_name = 'enet_b0_tuned'
    model_dir = '/projects/jogr4852/clotsimnet/ml/models/enet_b0'
    # model_dir = '/home/josh/clotsimnet/ml/models/enet_b0'
     
    # Path to hyperparameter JSON file
    hyperparams_path = os.path.join(os.path.abspath(os.path.join(os.path.dirname(__name__), '..')), 'hp_tune', 'hyper_params', 'best_params_enet_b0.json')
