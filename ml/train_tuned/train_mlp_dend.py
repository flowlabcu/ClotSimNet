...
if __name__ == '__main__':
    ...
    # os.path.join(os.path.abspath(os.path.join(os.path.dirname(__name__), '..')), 'hp_tune', 'hyper_params', 'best_params_mlp_dend.json')
