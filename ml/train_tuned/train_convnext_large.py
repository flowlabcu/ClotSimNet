...
from model_classes import ConvNeXt_Large
from data_modules import image_transformations, load_data

"""
train_convnext_large.py

Trains the ConvNext-Large architecture using tuned hyperparameters.
...
- hyperparams_path (str): Path to hyperparameter JSON file. Automatically looks for it in path clotsimnet/ml/hp_tune/hyperparams/best_params_convnext_large.json, but can be changed as needed.

Usage:
    python3 train_convnext_large.py
...
"""
    ...
    RUN_NAME = 'ConvNext_Large_Tuned'
    
    # Model export settings/names
    model_name = 'convnext_large_tuned'
    model_dir = '/projects/jogr4852/clotsimnet/ml/models/convnext_large'
...
if __name__ == '__main__':
    ...
    model_type = 'ConvNext_Large_tuned'
    dataset_size = '5k'
    ...
    hyperparams_path = os.path.join(os.path.abspath(os.path.join(os.path.dirname(__name__), '..')), 'hp_tune', 'hyper_params', 'best_params_convnext_large.json')
    ...
    model = ConvNeXt_Large.ConvNeXtLarge(
