...
Trains the ResNet-50 architecture using tuned hyperparameters.
...
- hyperparams_path (str): Path to hyperparameter JSON file. Automatically looks for it in path clotsimnet/ml/hp_tune/hyperparams/best_params_resnet_50.json, but can be changed as needed.

Usage:
    python3 train_resnet_50.py
...
if __name__ == '__main__':
    ...
    RUN_NAME = 'ResNet50_Tuned'
    
    # Model export settings/names
    model_name = 'resnet_50_tuned'
    model_dir = '/projects/jogr4852/clotsimnet/ml/models/resnet_50'
    # model_dir = '/home/josh/clotsimnet/ml/models/resnet_50'
     
    # Path to hyperparameter JSON file
    hyperparams_path = os.path.join(os.path.abspath(os.path.join(os.path.dirname(__name__), '..')), 'hp_tune', 'hyper_params', 'best_params_resnet_50.json')
