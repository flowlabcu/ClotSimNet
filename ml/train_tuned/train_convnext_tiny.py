...
Trains the ConvNext-Tiny architecture using tuned hyperparameters.
...
- hyperparams_path (str): Path to hyperparameter JSON file. Automatically looks for it in path clotsimnet/ml/hp_tune/hyperparams/best_params_convnext_tiny.json, but can be changed as needed.

Usage:
    python3 train_convnext_tiny.py
...
if __name__ == '__main__':
    ...
    model_type = 'ConvNext_Tiny_tuned'
    dataset_size = '5k'
    ...
    hyperparams_path = os.path.join(os.path.abspath(os.path.join(os.path.dirname(__name__), '..')), 'hp_tune', 'hyper_params', 'best_params_convnext_tiny.json')
