...
if __name__ == '__main__':
    ...
    wandb_logger.experiment.tags = [model_type, f'{dataset_size}_dataset', f'lr_{learning_rate}', f'bs_{batch_size}', f'{hp_tune}', f'machine_{machine}', f'data_aug_{data_aug}']
    ...
    model_dir = '/projcets/jogr4852/clotsimnet/ml/models/'
