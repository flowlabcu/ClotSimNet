...
def paraview_convert(case_dir):
    ...
    c000000vtu = XMLUnstructuredGridReader(registrationName='c000000.vtu', FileName=[vtu_path]) # Might need 'vtu_path' instead of vtu_path
    ...
    c000000vtuDisplay.ScaleTransferFunction.Points = [-0.0001725274020576925, 0.0, 0.5, 0.0, 13.134648731866344, 1.0, 0.5, 0.0]

    # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    c000000vtuDisplay.OpacityTransferFunction.Points = [-0.0001725274020576925, 0.0, 0.5, 0.0, 13.134648731866344, 1.0, 0.5, 0.0]
    ...
    # init the 'PiecewiseFunction' selected for 'ScaleTransferFunction'
    pythonCalculator1Display.ScaleTransferFunction.Points = [-0.0001725274020576925, 0.0, 0.5, 0.0, 13.134648731866344, 1.0, 0.5, 0.0]

    # init the 'PiecewiseFunction' selected for 'OpacityTransferFunction'
    pythonCalculator1Display.OpacityTransferFunction.Points = [-0.0001725274020576925, 0.0, 0.5, 0.0, 13.134648731866344, 1.0, 0.5, 0.0]
    ...
    layout1.SetSize(1074, 427)

    # current camera placement for renderView1
    renderView1.InteractionMode = '2D'
    renderView1.CameraPosition = [1.0, 0.5, 10000.0]
    renderView1.CameraFocalPoint = [1.0, 0.5, 0.0]
    renderView1.CameraParallelScale = 0.5215711070771517

    # save screenshot
    image_path = os.path.join(case_dir, 'output', f'{sim_id}.jpeg')
    SaveScreenshot(image_path, renderView1, ImageResolution=[1074, 427],
...
# paraview_convert(case_dir='/projects/jogr4852/clotsimnet/test_pipeline/aN_447_rp_017_seed_1')