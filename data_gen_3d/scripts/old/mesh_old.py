...
class MeshGenerator():
    def __init__(self, sources_dir: str, max_time_sec: float=60):
        '''
    ...
    def write_mesh(self, radius: float, num_pores: int, seed: int, mesh_size: float, case_dir: str, max_time_sec: float):
        '''
    ...
    def generate_mesh(self, radius: float, num_pores: int, seed: int, mesh_size: float, case_dir: str):
        '''
